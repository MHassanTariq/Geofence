...
class HuntMainActivity : AppCompatActivity() {
    ...
    private var runningQOrLater = android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O
    ...
    // when will we call this function as we never call onActivityForResult()
    ...
    private fun addGeofenceForClue() {
        ...
        //Getting current Geofence data
        val currentGeofenceData : LandmarkDataObject = GeofencingConstants
            .LANDMARK_DATA[currentGeofenceIndex]
